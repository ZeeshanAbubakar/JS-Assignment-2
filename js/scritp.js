...
document.getElementById("concatenation").onclick = function () {
    ...
    document.getElementById("input-box").innerHTML = '<p>"Any Type of Text in this String" + " " + "Zeeshan Abubakar" + "!"</p>'
...
document.getElementById("ifStatementNested").onclick = function(){
    ...
    if(userName === "Zeeshan Abubakar"){
        ...
        if(password == 1122){
            ...
            document.getElementById("output-box").innerHTML = `<span class='text-danger'>${password}</span> is incorrect password. <br> correct password is <span class='text-success'>1122</span>`
        }
    }
    else{
        document.getElementById("output-box").innerHTML = `<span class='text-danger'>${userName} </span> is incorrect user name. <br> correct user name is <span class='text-success'> "Zeeshan Abubakar"</span>`
    }
}
...
document.getElementById("login").onclick = function (){
    ...
    let passWord = +prompt("please enter password")
    if (userName === "Zeeshan Abubakar" && passWord === 1122 ){
        document.getElementById("form").innerHTML = `<span style='color:green; font-weight:bold;'>${userName}</span>`
        document.getElementById("output-box").innerHTML = `<span style='color:green; text-transform:capitalize;'>you are successfully logged in</span>`
    }
    else {
        document.getElementById("output-box").innerHTML = "Try using Zeeshan Abubakar as username and 1122 as a password"
    }
